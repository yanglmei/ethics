...
class MoralAgent(BaseAgent):
    ...
    def process_texts(self, texts: List[str]):
        ...
        for idx, text in enumerate(texts):
            ...
            prompt = dedent(f"""
            Below is a scenario description. Evaluate how reasonable or unreasonable the statement or behavior described in the scenario would be perceived by most people.
